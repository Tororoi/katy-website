          ...
          <div className="site-content">
            ...
            <main>
              <Route
                path="/exhibitions"
                exact
                render={() => <ExhibitionsContainer />}
              />
              <Route path="/bio" exact render={() => <AboutPage />} />
              <Route
                path="/project"
                exact
                render={() => (
              ...
              <Route path="/" exact render={() => <ProjectContainer />} />
              {/* <Media/> */}
            </main>
          </div>
        </Router>
...
export default withRouter(connect(null, sendThisInformation)(App))
